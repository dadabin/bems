...
/**
 * @ClassName: JfreeUtils 说明： TODO(Tell the reader such role.)
 * @Author SUN 【email:1096490965@qq.com】
 * @Version V1.0 2012-7-14 下午9:52:37
 * 
 */
public class JfreeUtils {
	 ...
	 * 生成分组的柱形图
	 */
	private void makeLineAndShapeChart() {
	...
	public void createLineAndShapeChart() {
	...
	public void makeBarGroupChart() {
		...
		String[] columnKeys = { "北京", "上海", "广州", "成都", "深圳" };
		CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
		createBarChart(dataset, "x坐标", "y坐标", "柱状图", "barGroup.jpg","");
	}
	...
	public void makeBarChart() {
		...
		String[] columnKeys = { "北京", "上海", "广州", "成都", "深圳" };
		CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
		createBarChart(dataset, "x坐标", "y坐标", "柱状图", "bar.jpg","");
	}
	...
	public void makeStackedBarChart() {
		...
		String[] columnKeys = { "北京", "上海", "广州", "成都", "深圳" };
		CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
		createStackedBarChart(dataset, "x坐标", "y坐标", "柱状图", "stsckedBar.jpg","");
	}
	 ...
	 * @param picName
	 */
	public void createPieChart(double[] data, String[] keys, String title,
			String picName) {
		createValidityComparePimChar(getDataPieSetByUtil(data, keys), "饼状图",
				"pie2.jpg", keys);
	}
	 ...
	 * @return
	 */
	private String createValidityComparePimChar(PieDataset dataset,
	...
	public String createBarChart(CategoryDataset dataset, String xName,
			String yName, String chartTitle, String charName,String path) {
		...
		// Font labelFont = new Font("SansSerif", Font.TRUETYPE_FONT, 12);//new
		// Font("隶书", Font.BOLD, 25)
		Font labelFont = new Font("隶书", Font.BOLD, 12);
		/*
	 ...
	 * @return
	 */
	private String createHorizontalBarChart(CategoryDataset dataset,
	...
	public String createTimeXYChar(String chartTitle, String x, String y,
			CategoryDataset xyDataset, String charName, String path) {
		...
		try {
			...
			// ChartUtilities.saveChartAsPNG(fos_jpg, fos_jpg, fos_jpg,
			// fos_jpg);
	 ...
	 * @return
	 */
	private String createStackedBarChart(CategoryDataset dataset, String xName,
			String yName, String chartTitle, String charName,String path) {
	...
	//////////////////////////////////
	public static void sun_test(){
		DefaultCategoryDataset dataset=new DefaultCategoryDataset();
		dataset.addValue(300, "广州", "苹果");
		dataset.addValue(200, "广州", "lizi");
		
		dataset.addValue(400, "广州", "果");
		
		JFreeChart chart=ChartFactory.createBarChart3D("水果", "", "", dataset, PlotOrientation.VERTICAL, false, false, false);
		//String filename=
		String charName="xx.jpg";
